...
mixin _$MovieDetail {
  ...
  String get releaseDate =>
      throw _privateConstructorUsedError; // convert voteAverage int to double
...
// convert voteAverage int to double
  ...
  @override
  String toString() {
    return 'MovieDetail(id: $id, title: $title, posterPath: $posterPath, overview: $overview, backdropPath: $backdropPath, runtime: $runtime, releaseDate: $releaseDate, voteAverage: $voteAverage, genres: $genres)';
  }
...
abstract class _MovieDetail implements MovieDetail {
  ...
  @override
  String get releaseDate;
  @override // convert voteAverage int to double
